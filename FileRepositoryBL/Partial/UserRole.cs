...
namespace FileRepository.BusinessObjects
{
    public partial class UserRole : Entity<UserRole>
    {
        ...
        public UserRole(bool defaults) : base(defaults) { }
        public UserRole()
        {
            Settings();
        ...
        public override void OnAudit(string eventType, Entity<UserRole> oldEntity, List<AuditLog> log)
        {
        ...
        public List<UserRole> SaveList(List<UserRole> oUserRoleList)
        {
            try
            {
                if (oUserRoleList == null || oUserRoleList.Count <= 0) return oUserRoleList;
                foreach (UserRole oUserRole in oUserRoleList)
                {
                    oUserRole.Save();
                }
