...
namespace FileRepository.BusinessObjects
{
    public partial class NotificationTo : Entity<NotificationTo>
    {
        ...
        public NotificationTo(bool defaults) : base(defaults) { }
        ...
        public override void OnAudit(string eventType, Entity<NotificationTo> oldEntity, List<AuditLog> log)
        {
        ...
        public List<NotificationTo> SaveList(List<NotificationTo> oNotificationToList)
        {
            try
            {
                if (oNotificationToList == null || oNotificationToList.Count <= 0) return oNotificationToList;
                foreach (NotificationTo oNotificationTo in oNotificationToList)
                {
                    oNotificationTo.Save();
                }
                return oNotificationToList;
            }
            catch (Exception ex)
            {
                throw (ex);
